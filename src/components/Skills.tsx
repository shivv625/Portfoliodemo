...
const skills: Skill[] = [
  { name: 'Java', progress: 90, icon: <Coffee /> },
  { name: 'C', progress: 85, icon: <Code2 /> },
  { name: 'Python', progress: 95, icon: <FileCode2 /> },
  { name: 'HTML', progress: 100, icon: <FileJson /> },
  { name: 'CSS', progress: 100, icon: <Cpu /> },
  { name: 'JavaScript', progress: 90, icon: <Boxes /> },
  { name: 'TensorFlow', progress: 80, icon: <Brain /> },
  { name: 'Keras', progress: 75, icon: <Network /> },
  { name: 'GitHub', progress: 95, icon: <Github /> },
  { name: 'Git', progress: 90, icon: <Git /> },
];
